...
Дополнения ublock,pupup blocked unlimite,addblock не решают данную проблемму. Закрытие окон после каждой операции и остановка выполнения скриптов лишь замедляет засорение swap.
<p align="left">
